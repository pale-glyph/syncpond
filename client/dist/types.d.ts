...
export type SyncpondServerMessage = SyncpondAuthOk | SyncpondRoomUpdate | SyncpondUpdate | SyncpondAuthError | {
    type: string;
    [key: string]: unknown;
};
export type SyncpondClientEvent = "open" | "close" | "error" | "auth_ok" | "auth_error" | "room_update" | "update" | "message";
